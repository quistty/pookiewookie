        ...
        if (command.startsWith("!")) {
            ...
            switch (actualCommand) { // all commands that can be run go here
                ...
                case "commands": 
                    ...
                    System.out.println("6. gambling - roulette, lottery tickets, slots");
                    ...
                    System.out.println("10. work - allows you to work at your job. Required 5 times yearly");
                ...
                case "gambling":
                    ...
                    System.out.println("1 for roulette, 2 lotto ticket, 3 for slots"); 
                    ...
                    if (gamblingResponse == 1) { 
                        ...
                        netWorth -= 20;
                        System.out.println("You spent $20 to buy a lottery ticket. May the odds be in your favour!");
                        boolean odds = oneMillionOdds();
                        if (odds == true){
                            netWorth += 70000000;
                            System.out.println("You won 70 milllion dollars! You're very lucky!");
                        } else {
